...
EPISODES = 100
location = "/home/rishav/Autonomous-Driving/decision-making-CarND/CarND-test/build"
...
while episode <= EPISODES:
    ...
    pool.join()
    conn = result[0].get()
    sim = subprocess.Popen('/home/rishav/Autonomous-Driving/decision-making-CarND/term3_sim_linux/term3_sim.x86_64')
    ...
    while True:
        ...
        if data == "over":
            ...
            with open('/home/rishav/Autonomous-Driving/decision-making-CarND/CarND-test/src/train/train.txt', 'a') as f:
                f.write(" episode {} epsilon {}\n".format(episode, agent.epsilon))
            close_all(sim)
            conn.close()
            with open('/home/rishav/Autonomous-Driving/decision-making-CarND/CarND-test/src/trainexp1.pkl', 'wb') as exp1:
                pickle.dump(agent.memory1, exp1)
            with open('/home/rishav/Autonomous-Driving/decision-making-CarND/CarND-test/src/train/exp2.pkl',
                      'wb') as exp2:
